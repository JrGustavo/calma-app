        ...
        <div className="max-w-prose mx-auto space-y-8">
          ...
          <Card variant="elevated">
            ...
            <p className="text-sm text-text-muted">
              La función de vincular un estudiante llegará pronto. Por ahora,
              acompaña a tu hijo/a directamente desde su cuenta.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p className="text-text-secondary mb-4">
              Recursos para acompañar el aprendizaje en casa.
            </p>
